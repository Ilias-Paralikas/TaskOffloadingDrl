...
def main():
        ...
        parser.add_argument('--default_private_cpu_capacity', type=float, default=1, help='Number of servers in the system')
        parser.add_argument('--private_cpu_capacities', type=str, default=None, help='Number of servers in the system')
        
        parser.add_argument('--default_public_cpu_capacity', type=float, default=1, help='Number of servers in the system')
        ...
        parser.add_argument('--cloud_capacities_min', type=float, default=1000, help='Number of servers in the system')
        ...
        parser.add_argument('--topology_generator', type=str, default='fully_connected', help='Number of servers in the system')
